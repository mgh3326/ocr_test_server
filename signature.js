    ...
    return {
        ...
        send: function () {
            ...
            if (empty == false) {
                ...
                dataform.setAttribute("action", "http://mgh3326.iptime.org:5000/fileUpload");
                dataform.setAttribute("enctype", "multipart/form-data");
                dataform.setAttribute("method", "POST");
                dataform.innerHTML = '<input type="text" name="image" value="' + dataURL + '"/>' + '<input type="submit" value="Click me" />';
                dataform.submit();
